    ...
    <footer className='h[684px] w[1280px]  p-[80px] flex flex-col gap-[80px] '>
      <div className="w[1120px] h[52px] flex flex-col gap-[80px]">
        ...
        <div className="w[1120px] h[225px] flex gap-2 justify-between">
            <div className="w-[250px] h-[40px]"><Image src= "Dd.png" alt="Logo" /></div>
        ...
        <div className="w[1120px] h-[57px] items-end border-solid border-black border-t-[2px] pt-[33px]">
            ...
            <div className='h-[24px] w-[24px]  flex justify-center items-center mr-[12px]'><Image className='' src= "facebook.png" alt="facebook" ></Image></div>
            <div className='h-[24px] w-[24px]  flex justify-center items-center mr-[12px]'><Image className='' src= "Instagram.png" alt="insta" ></Image></div>
            <div className='h-[24px] w-[24px]  flex justify-center items-center mr-[12px]'><Image className='' src= "Twitter.png" alt="{twitter" ></Image></div>
            <div className='h-[24px] w-[24px]  flex justify-center items-center '><Image className='' src="LinkedIn.png" alt="linkedin.png" ></Image></div>
        </div>
            </div>
        </div>
      </div>

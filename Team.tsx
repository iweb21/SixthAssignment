        ...
        <div className='h-[209px] xl:w-[1060px] md:w-[760px] sm:w-[640px] w-[428px] flex flex-row xl:gap-[48px] justify-between '>
            <div className="w[394.67px] h-[209px] flex flex-col gap-[24px] items-center">
                ...
                <div className="w[100px] h-[24px] flex  gap-[14px] mx[147.33px]">
                    <div className="w-[24px] h-[24px] flex items-center justify-center"><Image className='w-[18px] h-[18px]' src="LinkedIn.png" alt="logo" ></Image></div>
                    <div className="w-[24px] h-[24px] flex items-center justify-center"><Image className='w-[18px] h-[15.3px]' src="Twitter.png"  alt="logo" ></Image></div>
                    <div className="w-[24px] h-[24px] flex items-center justify-center"><Image className='w-[18px] h-[18px]' src="Dribble.png" alt="logo" ></Image></div>
                </div>
            </div>
            {/* profile 2 */}
            <div className="w[394.67px] h-[209px] flex flex-col gap-[24px] items-center">
                <div className="w-[80px] h-[80px] mx[157.33px]">
                    <Image src="nurse.png"alt="Pic" />
                </div>
                <div className="w[394.67px] h-[57px]">
